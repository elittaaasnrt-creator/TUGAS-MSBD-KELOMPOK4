-- Diminta: menyiapkan skema lab5 beserta tipe data dan tabel transaksi.
-- Dipilih: enum + domain agar keadaan tidak sah (status tak dikenal, jumlah negatif) ditolak di level basis data.
-- Alternatif: CHECK constraint biasa tanpa domain/enum; tidak dipilih karena kurang reusable dan validasinya tersebar.
